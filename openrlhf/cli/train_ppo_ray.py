...
if __name__ == "__main__":
    ...
    parser.add_argument("--bonus_reward_coef", type=float, default=0.2, help="Bonus reward weight for correct answers")
    parser.add_argument("--bonus_constraint", type=float, default=100, help="Bonus reward length constraint")
    parser.add_argument("--use_dyna_weight", action="store_true", default=False, help="whether to use dynamic weighting and sampling")
    parser.add_argument("--use_bonus", action="store_true", default=False, help="whether to use bonus reward")
    parser.add_argument("--aux_loss_coef", type=float, default=0, help="MoE balancing loss")
    parser.add_argument("--diff_coef", type=float, default=1.8, help="sigma in f(d)")
